...
const MatchRunesFull = ({ participant }) => {
      ...
      >
        ...
        >
          <Stack spacing={1}>
            ...
            <Rune rune={secondaryStyleName} width={35} height={35} />
          </Stack>
          <Stack spacing={1} alignItems="center" justifyContent="center">
            ...
            <Stack direction="row" spacing={0.3}>
              {statPerksIcons.map((icon, index) => (
                <img
                  src={`https://opgg-static.akamaized.net/meta/images/lol/latest/perkShard/${icon}.png?image=q_auto,f_webp,w_48&v=1681967972545`}
                  alt="statPerk"
                  width={25}
                  height={25}
                  style={{
