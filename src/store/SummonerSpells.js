// 20230405222250
// https://ddragon.leagueoflegends.com/cdn/13.7.1/data/en_US/summoner.json
...
export const SummonerSpellNames = {
    ...
    data: {
        SummonerBarrier: {
            ...
            tooltip:
                "Temporarily shields {{ tooltipabsorbeddamage }} damage from your champion for 2 seconds.",
            maxrank: 1,
            cooldown: [180],
            cooldownBurn: "180",
            cost: [0],
        ...
        SummonerBoost: {
            ...
            tooltip:
                "Removes all disables (excluding suppression and airborne) and summoner spell debuffs affecting your champion and reduces the duration of disables by 65% for the next {{ e2 }} seconds.",
            maxrank: 1,
            cooldown: [210],
            cooldownBurn: "210",
            cost: [0],
        ...
        SummonerExhaust: {
            ...
            tooltip:
                "Exhausts target enemy champion, reducing their Move Speed by {{ e5 }}%, and their damage dealt by {{ damagereductiontooltip }}% for 3 seconds.",
            maxrank: 1,
            cooldown: [210],
            cooldownBurn: "210",
            cost: [0],
            costBurn: "0",
            datavalues: {},
            effect: [null, [3], [35], [0], [0], [30], [0], [0], [0], [0], [0]],
            effectBurn: [
                null,
                "3",
                "35",
        ...
        SummonerHaste: {
            ...
            tooltip:
                "For {{ duration }} seconds, your champion can move through units and gains {{ movespeedmod }} Move Speed.<br /><br />Ghost extends its duration by {{ takedownextension }} seconds on takedown.",
            maxrank: 1,
            cooldown: [210],
            cooldownBurn: "210",
            cost: [0],
        ...
        SummonerHeal: {
            ...
            name: "Heal",
            description:
                "Restores 80-318 Health (depending on champion level) and grants 30% Move Speed for 1 second to you and target allied champion. This healing is halved for units recently affected by Summoner Heal.",
            tooltip:
        ...
        SummonerMana: {
            ...
            tooltip:
                "Restores {{ e1 }}% maximum Mana to your Champion and {{ e2 }}% to nearby allies.",
            maxrank: 1,
            cooldown: [240],
            cooldownBurn: "240",
            cost: [0],
        ...
        SummonerSmite: {
            ...
            tooltip:
                'Deals <span class="colorFEFCFF">{{ f1 }}</span> true damage to target monster or minion.<br />',
            maxrank: 1,
            cooldown: [15],
            cooldownBurn: "15",
            cost: [0],
        ...
        SummonerSnowURFSnowball_Mark: {
            ...
            tooltip:
                'Throw a snowball a long distance, dealing {{ tooltipdamagetotal }} true damage to the first enemy unit hit and granting <span class="coloree91d7">True Sight</span> of the target. If it hits an enemy, this ability can be recast for {{ e3 }} seconds to Dash to the tagged unit, dealing an additional {{ tooltipdamagetotal }} true damage. Dashing to the target will reduce the cooldown of Mark by {{ e4 }}%.<br /><br /><span class="colorFFFF00">Mark projectiles are not stopped by spell shields or projectile mitigation.</span>',
            maxrank: 1,
            cooldown: [80],
            cooldownBurn: "80",
            cost: [0],
        ...
        Summoner_UltBookPlaceholder: {
            ...
            tooltip:
                "Will be replaced by your Ultimate Summoner Spell selection.{{ spellmodifierdescriptionappend }}",
            maxrank: 1,
            cooldown: [0],
            cooldownBurn: "0",
            cost: [0],
        ...
        Summoner_UltBookSmitePlaceholder: {
            ...
            tooltip:
                "Will be replaced by your Ultimate Summoner Spell.<br /><br />Gain Attack-Smite. Attack-Smite will execute allied Buff Monsters, Epic Monsters, and Scuttle Crabs when you attack them.<br /><br /><attention>Attack-Smite does not have a cooldown.</attention>{{ spellmodifierdescriptionappend }}",
            maxrank: 1,
            cooldown: [0],
            cooldownBurn: "0",
            cost: [0],
